...
$(document).on("ready", function(){ 
	...
	$(".tidyName").click(function() { 
	 ...
	 document.getElementsByTagName("input")[0].value= "Panthera Tigris Tigris"; 
	 document.getElementsByTagName("textarea")[0].value= "La luz del Sol bri-lla a-ma-ri-lla\nbri-llan-tes cru-ci-fi-jos gri-ses cuel-gan de los cue-llos\nhoy es el dí-a que que-rí-a-mos a-yer."; 
	getDedications("español", document.getElementsByTagName("textarea")[1]); 
	getDedications("english", document.getElementsByTagName("textarea")[2]); 
})
